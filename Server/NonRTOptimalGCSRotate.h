#ifndef NONRT_OPTIMAL_GCS_ROTATE_H
...
namespace TimeOptimal
{
    ...
    //                           0.3, -0.85,  0.65 };//024 swing, 135 stance
        ...
        double s_b[2201] {0};
        double b_sb[2201][3] {{0}};
        double db_sb[2201][3] {{0}};
        double ddb_sb[2201][3] {{0}};
...
//        double output_const3[2201][18] {{0}};
        ...
        double s_b_mtrx_scale[2201][3] {{0}};
        double output_init_pva_b[2201][9] {{0}};
        double pva_b[2201][9] {{0}};
